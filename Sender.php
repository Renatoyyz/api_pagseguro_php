...
class Sender {//class
    ...
    public function __construct(string $name, Document $cpf, DateTime $bornDate, Phone $phone,string $email, string $hash ){//__construct
        ...
        if( !filter_var($email, FILTER_VALIDATE_EMAIL) ){
            throw new Exception("Informe uma E-mail válido.");
        }
